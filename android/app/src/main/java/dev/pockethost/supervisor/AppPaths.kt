...
object AppPaths {
    ...
    fun matrixConfig(context: Context): File = File(configDir(context), "dendrite.yaml")
    fun matrixSigningKey(context: Context): File = File(matrixRoot(context), "matrix_key.pem")
